...
namespace Uppgift08
{
    class traningsgrupp
    {
        ...
        //public List<traningsgrupp> hamtaTraningsgrupp()
        //{
        //    List<traningsgrupp> nyTraningsgrupp = new List<traningsgrupp>();
        //    DataTable traningsGrupp;
        //    string fråga = "sokGrp";
        //    traningsGrupp = nyPostGress.sqlFråga(fråga);
        //    nyTraningsgrupp.Add(traningsGrupp);
        //}
